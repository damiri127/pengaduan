...
<div class="card shadow">
    ...
    <a class="btn btn-success" href="proses.php?id=<?php echo $data['id_pengaduan']; ?>">
      <span class="icon text-white-50">
      <i class="fas fa-check"></i>
      </span>
      <span class="text" onclick="return confirm('Apakah anda yakin akan diproses?')">Proses</span>
    </a>
