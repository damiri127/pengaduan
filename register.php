                            ...
                            <form class="user" method="post" action="simpan_masyarakat.php">
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" name="nik" class="form-control form-control-user" id="nik" placeholder="NIK" maxlength="16" required="">
                                        <span></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="username"
                                       name="user" placeholder="Masukan Username..." required="">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-user" id="password"
                                       name="pass" placeholder="Masukan Password..." required="">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="telp"
                                      name="telp"  placeholder="Masukan Nomor Telepon..." maxlength="13" required="">
                                </div>
